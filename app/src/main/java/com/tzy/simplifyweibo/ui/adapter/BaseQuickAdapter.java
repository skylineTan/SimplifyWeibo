...
import com.tzy.simplifyweibo.ui.animation.AlphaInAnimation;
import com.tzy.simplifyweibo.ui.animation.BaseAnimation;
import com.tzy.simplifyweibo.ui.animation.ScaleInAnimation;
import com.tzy.simplifyweibo.ui.animation.SlideInBottomAnimation;
import com.tzy.simplifyweibo.ui.animation.SlideInLeftAnimation;
import com.tzy.simplifyweibo.ui.animation.SlideInRightAnimation;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private BaseViewHolder getLoadingView(ViewGroup parent) {
        if (mLoadingView == null) {
            return createBaseViewHolder(parent, R.layout.view_foot_loading);
        }
