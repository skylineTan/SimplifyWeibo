...
import com.tzy.simplifyweibo.ui.widget.SpanGridLayout;
...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setStatusText(int viewId, CharSequence value) {
        StatusTextView view = getView(viewId);
        view.setContent(value.toString());
        return this;
    }
    ...
    public BaseViewHolder setImagesUrl(int viewId, List<String> imageUrls){
        SpanGridLayout view = getView(viewId);
        view.setData(imageUrls);
        return this;
    }
